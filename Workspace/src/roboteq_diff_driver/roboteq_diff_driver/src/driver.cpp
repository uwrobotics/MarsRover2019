  ...
  encoder_cpr(0)
{
  ...
  nhLocal.param<std::string>("port_back", port_back, "/dev/ttyACM0");
  ROS_INFO_STREAM("port: " << port_back);
  nhLocal.param<std::string>("port_right", port_right, "/dev/ttyACM2");
  ROS_INFO_STREAM("port: " << port_right);
  nhLocal.param<std::string>("port_left", port_left, "/dev/ttyACM3");
  ...
  nhLocal.param("wheel_circumference", wheel_circumference, 0.73);
  ROS_INFO_STREAM("wheel_circumference: " << wheel_circumference);
  nhLocal.param("track_width", track_width, 1.000);
