...
float ACCEL_X_MIN = -254.27;
float ACCEL_X_MAX = 254.27;
float ACCEL_Y_MIN = -252.81;
float ACCEL_Y_MAX = 261.47;
float ACCEL_Z_MIN = -251.95;
float ACCEL_Z_MAX = 259.77;
...
float magn_ellipsoid_center[3] = {266.872, -84.5898, 673.474};
float magn_ellipsoid_transform[3][3] = {{0.998673, 0.00274311, 0.00742471}, {0.00274311, 0.965823, -0.00560792}, {0.00742471, -0.00560792, 0.955122}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = 0.00;
float GYRO_AVERAGE_OFFSET_Y = -0.04;
